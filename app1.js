...
Branchs.prototype.render = function () {
    ...
    for (var i = 0; i < operationHour.length; i++) {
        var actuallyCustomer = generateRandomCustomer(this.maxiumumCustomerPerHour, this.minimumCustomerPerHour);
        var totalCookiesInThisHour = Math.floor(actuallyCustomer * this.averageCookiesPerCustomer);
